...
Feature: MoonCreation
  ...
  Test case to check if the name of the moon needs to be unique in order to be successful created (Equivalence Partitioning testing).
    ...
    Examples:
      | Home page                         | Moon name | Moon image | Moon Created? | Result                                                                    | Planet ID |
      | https://localhost/8080/plantarium | Deimos2    | moon-3.jpg | true          | (no alert, table refresh)                                                 | 2         |
  ...
  Test case to check if the planet provided for the moon to be created needs to be owned by the user and not someone else's (Equivalence Partitioning testing).
    ...
    Examples:
      ...
      | https://localhost/8080/ | Deimos2    | true          | (no alert, table refresh)                                         | 2         | Batman   | I am the night | moon-2.jpg |
      | https://localhost/8080/ | Deimos2    | false         | Failed to create Moon orbiting planet ${planetId} with name ${name} | 2         | Toby     | Butter      | moon-2.jpg |
      | https://localhost/8080/ | Deimos2    | false         | Failed to create Moon orbiting planet ${planetId} with name ${name} | 3         | Toby     | Butter      | moon-2.jpg |
  ...
  Test case to check if a user can create a moon with or without an image associated with it (Error Guess testing).
    ...
    Examples:
      ...
      | https://localhost/8080/plantarium | Deimos2    | 2         | moon-1.jpg         | true          |
      | https://localhost/8080/plantarium | Deimos2   | 2         | realistic-moon.png | true          |
      | https://localhost/8080/plantarium | Deimos2    | 2         |                    | true          |
